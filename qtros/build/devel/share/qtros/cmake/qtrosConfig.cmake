...
if("TRUE" STREQUAL "TRUE")
  set(qtros_SOURCE_PREFIX /home/slahuddin/catkin_ws/src/qtros)
  set(qtros_DEVEL_PREFIX /home/slahuddin/catkin_ws/src/qtros/build/devel)
  set(qtros_INSTALL_PREFIX "")
  set(qtros_PREFIX ${qtros_DEVEL_PREFIX})
else()
  set(qtros_SOURCE_PREFIX "")
  set(qtros_DEVEL_PREFIX "")
  set(qtros_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Slahuddin <Slahuddin@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/slahuddin/catkin_ws/src/qtros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT qtros_NUM_DUMMY_TARGETS)
      set(qtros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::qtros::wrapped-linker-option${qtros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR qtros_NUM_DUMMY_TARGETS "${qtros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::qtros::wrapped-linker-option${qtros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND qtros_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/slahuddin/catkin_ws/src/qtros/build/devel/lib;/opt/ros/melodic/lib)
